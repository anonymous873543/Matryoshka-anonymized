...
run-exp () {
  ...
  ./exp-spark5.sh $resultDir/result-$classname-$totalSize-$numGroups.csv conf/nested/conf_BounceRateSpark anonymous.bouncerate.$classname TOBEFILLED.jar $totalSize $numGroups $skewExponent
}
